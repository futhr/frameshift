...
**Status:** normative final-milestone technical specification; implementation open
**Revision date:** 2026-09-25
**Milestone:** F — FINAL, after the complete independent shopping list (D) and research/operational qualification (E)
...
The milestone includes all transactional provider integrations, purchasing/service packs, commitment UI, fulfillment and care. Earlier milestones may define contracts and qualify reusable seams, but do not implement a partial checkout at the expense of the complete independent journey. The [build-platform plan](build-platform.md) defines the required sequence. [Conjunct adoption](../research/conjunct-adoption.md) defines the generic versus product-specific ownership.
