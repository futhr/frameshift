...
| Release links identify signed exact archive bytes before publication | Release | Detached Ed25519 manifest verification, strict schema, HTTPS/versioned URL, regular-file size/digest, tamper, and trusted-key tests required; signed real artifacts and publication acceptance required | Manifest contract specified; verifier, owner key, and real artifacts remain open |
