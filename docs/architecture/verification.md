...
| Release links identify signed exact archive bytes before publication | Release | `scripts/check release` exercises detached Ed25519 verification, strict schema, HTTPS/versioned URL, regular-file size/digest, tamper, and trusted-key refusal; signed real artifacts and publication acceptance required | Local verifier and adversarial fixtures pass; owner-pinned production key, signed artifacts, guide links, and public distribution remain open |
