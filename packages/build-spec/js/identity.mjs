...
/** Internal adapter: the supplied shared codec validates before hashing. */
export async function canonicalIdentity(text, payloadFor) {
  if (typeof text !== 'string') return { ok: false, error: 'invalid_document' };
  const result = payloadFor(text);
